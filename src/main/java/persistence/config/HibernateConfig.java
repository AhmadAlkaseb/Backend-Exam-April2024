...
public class HibernateConfig {
    ...
    private static EntityManagerFactory buildEntityFactoryConfig() {
        ...
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/exam?currentSchema=public");
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        ...
        configuration.addAnnotatedClass(SellerJPA.class);
        configuration.addAnnotatedClass(CarJPA.class);
